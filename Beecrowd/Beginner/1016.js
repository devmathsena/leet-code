...
const kilometers = parseInt(lines[0]);

function calcTimeReachDistance(kilometers) {
    const time = (kilometers*60) / 30;
    return time;
}

const timeReachDistance = calcTimeReachDistance(kilometers);

console.log(`${timeReachDistance} minutos`);